...
class KubernetesClientCluster(BaseCloudConnector):
    ...
    def __init__(self, config_holder):
        ...
        super(KubernetesClientCluster, self).__init__(config_holder)
    ...
    def _start_image(self, user_info, node_instance, vm_name):
        ...
        return self._start_container_in_k8s(user_info, node_instance, container_name)
